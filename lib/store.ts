...
export interface CoursePlan {
  ...
  /** 🔁 تاريخ (yyyy-mm-dd) سريان بداية/اتجاه المراجعة الجديدين: سجلات المراجعة قبله لا تُحسب
      لموضع المراجعة القادم — يُضبط تلقائياً عند تغيير البداية أو الاتجاه بعد وجود سجلات سابقة */
  murSince?: string;
