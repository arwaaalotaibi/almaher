...
// عدد آيات كل سورة (بالترتيب — عدّ حفص)
...
/** عدد آيات سورة بالاسم */
export function ayahCount(surah: string): number {
  const i = SURAHS.indexOf(surah);
  return i >= 0 ? SURAH_AYAHS[i] : 0;
}
