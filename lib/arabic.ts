...
/** أوجه مجرورة بالباء: «بوجه واحد، بوجهين، بـ٣ أوجه، بـ١١ وجهاً» */
export const byFaces = (n: number) =>
  n === 1
    ? "بوجه واحد"
    : n === 2
      ? "بوجهين"
...
/** لقاءات مجرورة بالباء: «بلقاء واحد، بلقاءين، بـ٣ لقاءات، بـ١١ لقاءً» */
export const byMeetings = (n: number) =>
  n === 1
    ? "بلقاء واحد"
    : n === 2
      ? "بلقاءين"
