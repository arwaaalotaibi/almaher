-- ============================================================
--  الماهر v13 — مقرر الحفظ/المراجعة في السباق بدقة ربع الوجه (١٫٥ وجه مثلاً)
--  نفس دالة v11 مع تقريب المقرر إلى أقرب ربع بدل العدد الصحيح. آمن لإعادة التشغيل.
-- ============================================================
...
as $$
  ...
  sess as (
    select x.student_id,
           ...
           sum(case when (round(coalesce((b.plan ->> 'hifz')::numeric, 0) * 4) / 4) > 0
